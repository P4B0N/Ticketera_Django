    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(default='Espera', max_length=50, verbose_name='Estado')),
                ('fecha_creacion', models.DateField(default=datetime.datetime(2022, 12, 11, 17, 0, 43, 308082, tzinfo=datetime.timezone.utc), verbose_name='Fecha de creación')),
                ('fecha_cierre', models.DateField(default=datetime.datetime(2023, 1, 10, 17, 0, 43, 308082, tzinfo=datetime.timezone.utc), verbose_name='Fecha de cierre')),
